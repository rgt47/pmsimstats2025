...
# Measurement schedules vary by design (8 points for Hybrid/OL+BDC, 4 for others)
measurement_weeks_hybrid <- c(4, 8, 9, 10, 11, 12, 16, 20)
measurement_weeks_ol_bdc <- c(4, 8, 12, 16, 17, 18, 19, 20)
# 4 evenly-spaced points for OL, Crossover, Parallel (20-week trial)
# 6-week gaps allow PD with c.bm = 0.3 (larger gaps fail PD test)
