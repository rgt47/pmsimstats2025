...
```bash
cd /Users/zenn/Dropbox/prj/alz/01-pmsimstats/pmsimstats2025/analysis/scripts
...
**Option B: RStudio**
```r
setwd("/Users/zenn/Dropbox/prj/alz/01-pmsimstats/pmsimstats2025/analysis/scripts")
...
```bash
mkdir -p /Users/zenn/Dropbox/prj/alz/01-pmsimstats/pmsimstats2025/analysis/output
```
...
```bash
open /Users/zenn/Dropbox/prj/alz/01-pmsimstats/pmsimstats2025/analysis/output/figure4_equivalent_hendrickson_style.pdf
```

**PNG (for presentations/web):**
```bash
open /Users/zenn/Dropbox/prj/alz/01-pmsimstats/pmsimstats2025/analysis/output/figure4_equivalent_hendrickson_style.png
```
...
```r
# Load results
load("/Users/zenn/Dropbox/prj/alz/01-pmsimstats/pmsimstats2025/analysis/output/full_pmsim_analysis_hyb_versus_co.RData")
...
pwd
# Should show: /Users/zenn/Dropbox/prj/alz/01-pmsimstats/pmsimstats2025/analysis/scripts
