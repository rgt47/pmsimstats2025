...
The original Hendrickson approach creates the interaction through differential correlations:

- On treatment: $\text{Cor}(\text{biomarker}, \text{BR}) = c_{\text{bm}}$
- Off treatment: $\text{Cor}(\text{biomarker}, \text{BR}) = 0$

This elegant approach embeds the interaction in the covariance structure. However, for the simplified model, explicit moderation is:
